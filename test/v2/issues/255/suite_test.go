...
import (
	...
	issue255default "github.com/TheSadlig/asyncapi-codegen/test/v2/issues/255/default"
	issue255ignoredates "github.com/TheSadlig/asyncapi-codegen/test/v2/issues/255/ignoredates"
...
func (suite *Suite) TestDefault() {
	...
	s := "toto"
	_ = issue255ignoredates.TestMessagePayload{
		DateProp:     &s,
		DateTimeProp: &s,
	}
}
